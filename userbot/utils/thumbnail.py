...
async def gen_thumb(thumbnail, title, userid, ctitle):
    ...
    image1 = Image.open(f"userbot/files/thumb{userid}.png")
    image2 = Image.open(f"userbot/files/{theme}.png")
    ...
    img.save(f"userbot/files/final{userid}.png")
    os.remove(f"userbot/files/temp{userid}.png")
    os.remove(f"userbot/files/thumb{userid}.png")
    final = f"userbot/files/final{userid}.png"
    return final
